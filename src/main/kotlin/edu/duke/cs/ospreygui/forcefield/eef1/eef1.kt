...
object EEF1 {
	...
	enum class AtomType(
		...
		/** carbonyl carbon */
		C(14.7, 0.0, 0.0, 0.0, 0.0),
		/** carbon with no hydrogens */
		CR(8.3, -0.89, -1.4, 2.22, 6.9),
		/** extended aromatic carbon with 1 */
		CR1E(23.7, -0.187, -0.25, 0.876, 0.0),
		/** extended aliphatic carbon with 1 H */
		CH1E(22.4, 0.372, 0.52, -0.61, 18.6),
		/** extended aliphatic carbon with 2 H */
		CH2E(30.0, 1.089, 1.5, -1.779, 35.6),
		/** extended aliphatic carbon with 3 H */
		CH3E(18.4, 0.057, 0.08, -0.973, 6.9),
		/** amide nitrogen */
		NH1(4.4, -5.95, -8.9, -9.059, -8.8),
		/** aromatic nitrogen with no hydrogens */
		NR(4.4, -3.82, -4.0, -4.654, -8.8),
		/** nitrogen bound to two hydrogens */
		NH2(11.2, -5.45, -7.8, -9.028, -7.0),
		/** nitrogen bound to three hydrogens */
		NH3(11.2, -20.0, -20.0, -25.0, -18.0),
		/** guanidinium nitrogen */
		NC2(11.2, -10.0, -10.0, -12.0, -7.0),
		/** proline nitrogen */
		N(0.0, -1.0, -1.55, -1.25, 8.8),
		/** hydroxyl oxygen */
		OH1(10.8, -5.92, -6.7, -9.264, -11.2),
		/** carbonyl oxygen */
		O(10.8, -5.33, -5.85, -5.787, -8.8),
		/** carboxyl oxygen */
		OC(10.8, -10.0, -10.0, -12.0, -9.4),
		/** sulphur */
		S(14.7, -3.24, -4.1, -4.475, -39.9),
		/** extended sulphur with one hydrogen */
		SH1E(21.4, -2.05, -2.7, -4.475, -39.9);
